              ...
              <div class="space-y-4">
                ...
                <div class="flex items-center gap-3">
                  ...
                  <select
                      ...
                      @change="updateOrder(selectedOrder.id, selectedOrder.status)"
                      :disabled="loading"
                      class="p-2 rounded border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 pr"
                  >
                  ...
                  <span v-if="loading" class="text-sm text-gray-500">Atualizando...</span>
                </div>
...
import {type OrderResponse, getOne, orderAdmin, updateStatus} from "@/api/auth/Order.ts";
...
export default defineComponent({
  components: {AdminSidebar, Navbar, Pagination, SearchBar, OrderCard },
  ...
  setup() {
    ...
    const fetchOrder = async (
      ...
      try {
        const payload = await orderAdmin(p, filters);
    ...
    return {
      ...
      /* Order modal */
      openOrderModal, closeOrderModal, selectedOrder, updateOrder,
